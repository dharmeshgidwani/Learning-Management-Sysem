    ...
    <div class="container-fluid remove-vid-marg">
      <div class="vid-parent">
        <video playsinline autoplay muted loop>
          <source src="video/video (2160p).mp4" />
        </video>
        <div class="vid-overlay" style="    background-color: #00DBDE;
    background-image: linear-gradient(90deg, #00DBDE 0%, #FC00FF 100%);  "></div>
      </div>
      <div class="vid-content" >
        <h1 class="my-content">Welcome to TechnoStacks</h1>
        <small class="my-content">Education for Every Learning Journey</small><br />
        <?php    
    ...
    <div class="container-fluid p-4" style="background-color:#E9ECEF">
      <div class="container" style="background-color:#E9ECEF">
        <div class="row text-center">
          ...
          <div class="col-sm">
            <h5>Contact Us</h5>
            <p>TechnoStacks <br> Chandigarh University </br> </p>
          </div>
        </div>
      </div>
